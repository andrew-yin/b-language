...
import { MEMORY_SIZE, WORD_SIZE } from './constants'
...
const createEmptyRuntime = () => ({
  ...
  agenda: [],
  stack: [],
  memory: new DataView(new ArrayBuffer(MEMORY_SIZE)),
  freeList: [WORD_SIZE], // initialize free list, save 0 address for null
