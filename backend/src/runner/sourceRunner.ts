...
import { ECError } from '../interpreter/types'
...
import { Context, Value, Variant } from '../types'
...
function runInterpreter(program: es.Program, context: Context, options: IOptions): Promise<Result> {
  ...
  return getPromise(context, value)
}

function getPromise(context: Context, value: Value): Promise<Result> {
